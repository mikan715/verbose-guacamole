...
def fetch_combine_store_data():
    try:
        ...
        #fixtures = 'https://v3.football.api-sports.io/fixtures?league=79&season=2024'
        ...
        for fixture in all_fixtures:
            ...
            cleaned_fixture = {
                "league": fixture.get("league", {}),  # Leeres Dict als Standardwert
                "fixture": fixture.get("fixture", {}),  # Leeres Dict als Standardwert
                "teams": fixture.get("teams", {}),
                "goals": fixture.get("goals", {}),
                "score": fixture.get("score", {}),
                "update": fixture.get("update", ""),  # Leerer String als Standardwert
                "bookmakers": matching_odds.get("bookmakers", []) # Leere Liste, falls keine Odds vorhanden sind
            }
            #print(cleaned_fixture)
            combined_data.append(cleaned_fixture)

        # Vor dem Speichern alle Einträge in der Collection löschen
        #collection_fixturesDFB.delete_many({})

        # Neue Daten in MongoDB speichern
        if combined_data:
            collection_fixturesDFB.insert_many(combined_data)
