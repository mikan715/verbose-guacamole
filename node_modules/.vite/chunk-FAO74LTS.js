...
function validateProps(rawProps, props, instance) {
  ...
  for (const key in options) {
    ...
    if (opt == null)
      continue;
    validateProp(key, resolvedValues[key], opt, true ? shallowReadonly(resolvedValues) : resolvedValues, !hasOwn(rawProps, key) && !hasOwn(rawProps, hyphenate(key)));
  }
}
...
function renderComponentRoot(instance) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(render22.length > 1 ? render22(true ? shallowReadonly(props) : props, true ? {
        get attrs() {
          markAttrsAccessed();
        ...
        slots,
        emit: emit2
      } : { attrs, slots, emit: emit2 }) : render22(true ? shallowReadonly(props) : props, null));
...
* @license MIT
**/
//# sourceMappingURL=chunk-FAO74LTS.js.map
